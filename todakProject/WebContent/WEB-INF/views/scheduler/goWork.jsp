...
<%
			...
			String hc_dayhour = cvo.getHc_dayhour();
			
			if(hc_dayhour == null){
				hc_dayhour  = "-";
			
			}else{
				int lastHour = Integer.parseInt(hc_dayhour) / 60;
				int lastMin =  Integer.parseInt(hc_dayhour) % 60;
				hc_dayhour = lastHour + "시간 " + lastMin + "분";
			}

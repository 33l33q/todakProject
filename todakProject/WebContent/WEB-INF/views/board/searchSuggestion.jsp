...
%>
	                     <tr class="ctr">
	                        ...
	                        <td align="center">
	                           <input type="button" class="button" id="fileDown" name="fileDown" value="이미지 다운로드">
	                        </td>
	                     </tr>
<%
                     }
...
%>
                  ...
                  <div class="suggestionsearch_align" align="center">
                     ...
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <input align="right" type="button" value="목록" class="button" id="selectSuggestion" name="selectSuggestion" 
                     style="width:60px;"/>
                  </div>
<%
            }else{

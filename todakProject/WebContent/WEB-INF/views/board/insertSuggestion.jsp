         ...
         <div align = "center">
            <form id="su_writeForm" name="su_writeForm" enctype="multipart/form-data" type="post">
               ...
               <div class="noticesearch_align" align="right">
                  <input type="button" value="저장" class="button" id="insertSuggestion" name="insertSuggestion" />
                  &nbsp; &nbsp;
                  <input type="button" value="목록" class="button" id="selectSuggestion" name="selectSuggestion"/>      
               </div>
            </form>
         </div>
         </div>
